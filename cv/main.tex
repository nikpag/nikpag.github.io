...
\begin{resume}
    ...
    \begin{rSection}{Experience}
        \begin{rSubsection}
            ...
            % \begin{jobDuties}
            %     Worked on improving scheduling for agentic workflows by reasoning about tool-calling execution times.  
            % \end{jobDuties}
        \end{rSubsection}
