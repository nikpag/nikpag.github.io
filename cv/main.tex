...
\begin{resume}
	...
	\begin{rSection}{Experience}
		...
		% 	\role{Research Intern} \hfill \place{Redmond, WA, US}
	...
	\begin{rSection}{Publications}
		...
		\begin{publicationItem}
			\paperTitle{VineLM: Trie-Based Fine-Grained Control for Agentic Workflows}
	...
	\begin{rSection}{Service}
		\begin{serviceItem}
			\service{CAIS 2026} \hfill 2026

			\role{\href{https://cais26-ae.hotcrp.com/u/0/users/pc}{Artifact Evaluation Committee}}
		\end{serviceItem}
		...
		\begin{serviceItem}
			...
			\role{\href{https://sosp25ae.hotcrp.com/u/0/users/pc}{Artifact Evaluation Committee}}
		\end{serviceItem}
